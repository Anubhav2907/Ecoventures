 ...
 const Reviews = () => {
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center pb-5">Checkout some recent Reviews</h1>
            </div>
...
//             <div class="cardd" id="cardd">
//   <img class="pp" src="https://pbs.twimg.com/profile_images/1027157166686396417/oPqePEYs_400x400.jpg" />
//   <h3>Vincent Corbalan</h3>
//   <h5>Hey ! I'm Vince, a French programmer <br/>student & photographer.<br/>Here're all my links !</h5>
//         </div>
//         <div class="cardd" id="cardd">
//   <img class="pp" src="https://pbs.twimg.com/profile_images/1027157166686396417/oPqePEYs_400x400.jpg" />
//   <h3>Vincent Corbalan</h3>
